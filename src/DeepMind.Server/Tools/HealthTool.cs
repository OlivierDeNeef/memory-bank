...
public class HealthTool
{
    ...
    public HealthTool(DeepMindDb db, MemoryStore store, BackupService backup,
    ...
    [McpServerTool(Name = "health_check"), Description("Check the health of the DeepMind database, indexes, and embedding model.")]
