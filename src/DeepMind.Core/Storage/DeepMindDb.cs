...
public class DeepMindDb : IDisposable
{
    private readonly SqliteConnection _connection;
    private readonly ILogger<DeepMindDb> _logger;
    private readonly DeepMindConfiguration _config;

    public DeepMindDb(DeepMindConfiguration config, ILogger<DeepMindDb> logger)
    {
        _config = config;
        _logger = logger;
