...
public class BackupService
{
    ...
    public BackupService(MemoryBankConfiguration config, ILogger<BackupService> logger)
    {
        _config = config;
        _logger = logger;
    }
    ...
    public string CreateBackup()
    {
        ...
        var backupPath = Path.Combine(_config.Backup.Path, $"memorybank_backup_{timestamp}.db");
    ...
    public string? GetLastBackupTime()
    {
        ...
        var latest = Directory.GetFiles(_config.Backup.Path, "memorybank_backup_*.db")
    ...
    private void EnforceRetention()
    {
        ...
        var backups = Directory.GetFiles(_config.Backup.Path, "memorybank_backup_*.db")
            .OrderByDescending(f => f)
            .ToList();
