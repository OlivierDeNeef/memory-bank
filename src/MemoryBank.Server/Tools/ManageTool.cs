...
public class ManageTool
{
    ...
    [McpServerTool(Name = "forget"), Description("IMPORTANT: Do NOT call this tool directly. Use the memorybank:forget skill instead, which handles search, confirmation, and subagent delegation. --- Delete a specific memory and all its chunks, revisions, embeddings, and links.")]
    ...
    [McpServerTool(Name = "bulk_forget"), Description("IMPORTANT: Do NOT call this tool directly. Use the memorybank:forget skill with --bulk instead, which handles confirmation and subagent delegation. --- Delete multiple memories matching filters.")]
    ...
    [McpServerTool(Name = "memory_stats"), Description("IMPORTANT: Do NOT call this tool directly. Use the memorybank:stats skill instead, which handles formatting and subagent delegation. --- Get statistics about the memory store.")]
