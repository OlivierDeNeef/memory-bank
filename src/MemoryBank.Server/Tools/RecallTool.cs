...
public class RecallTool
{
    ...
    [McpServerTool(Name = "recall"), Description("IMPORTANT: Do NOT call this tool directly. Use the memorybank:recall skill instead, which handles subagent delegation and clean output formatting. --- Search and recall memories using hybrid search (keyword + semantic + priority). Returns ranked results.")]
    ...
    [McpServerTool(Name = "recall_recent"), Description("IMPORTANT: Do NOT call this tool directly. Use the memorybank:recall skill instead, which handles subagent delegation and clean output formatting. --- Recall memories stored within a recent time window.")]
